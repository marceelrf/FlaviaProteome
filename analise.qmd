...
create_heatmap <- function(gene_list, sample_pattern, filename, title = "") {
  
  hm_mat <- hm_data_total %>% 
...
create_heatmap(
  ...
  title = "AA CKD vs AA - Paper Proteins"
)
...
print("Heatmaps salvos em Output/pub_plots/")
...
deglist <- list(
  "AA CKD vs. CKD" = fn_ORA_gene_diff(AA_CKD_vs_CKD_tibble),
  "AA CKD vs. AA" = fn_ORA_gene_diff(AA_CKDxAA_tibble),
  "AA vs. NT" = fn_ORA_gene_diff(AAxNT_tibble)
)
